...
* [threathunterX/nebula](https://github.com/threathunterX/nebula) - [已归档] Nebula 1.x —— 2019 年停止维护,依赖技术栈均已 EOL,请勿用于生产。新版本见 threathunterX/nebula2
...
* [emrearmagan/atlas.nvim](https://github.com/emrearmagan/atlas.nvim) - A Neovim plugin to browse and manage pull requests and issues across GitHub, GitLab, Bitbucket, and Jira without leaving your editor.
...
* [SovereignSatellite/FiOne](https://github.com/SovereignSatellite/FiOne) - Lua 5.1 bytecode interpreter, in Lua
...
* [dexter-xD/rhythm](https://github.com/dexter-xD/rhythm) - A modern Linux music player with stunning visualizations.
...
* [NvChad/showkeys](https://github.com/NvChad/showkeys) - Minimal Eye-candy keys screencaster for Neovim  200 ~ LOC
...
* [Sleitnick/Knit](https://github.com/Sleitnick/Knit) - Lightweight game framework for Roblox
...
* [zaldih/themery.nvim](https://github.com/zaldih/themery.nvim) - 🎨 Convenient plugin to switch between themes installed in neovim through a menu.
